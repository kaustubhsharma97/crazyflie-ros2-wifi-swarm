#!/usr/bin/env python3
"""
swarm_circle_concentric.py - ROS2 Humble / rclpy - TWO-DRONE CONCENTRIC CIRCLES
================================================================================
...
R1      = 0.7                  # cf231 inner radius (m)
R2      = 1.3                  # cf2   outer radius (m)
...
CSV_PATH = os.path.expanduser("~/swarm_circle_concentric_log.csv")
PNG_XY   = os.path.expanduser("~/swarm_circle_concentric_xy_topdown.png")
PNG_Z    = os.path.expanduser("~/swarm_circle_concentric_z.png")
PNG_3D   = os.path.expanduser("~/swarm_circle_concentric_3d.png")
PNG_ERR  = os.path.expanduser("~/swarm_circle_concentric_error.png")

RADII = {D1: R1, D2: R2}
PHASE_OF = {D1: 0.0, D2: PHASE}


class SwarmCircleConcentric(Node):
    def __init__(self):
        super().__init__("swarm_circle_concentric")
        ...
        self.get_logger().info(
            ...
            f"same z={FLY_Z}, 180deg phase -> {R1+R2:.1f} m constant separation")
    ...
    def _tick(self):
        ...
        if s=="WAIT_POSE":
            ...
            self.get_logger().info(
                f"Concentric centre ({self.cx:.2f},{self.cy:.2f}); rings r={R1}/{R2}, "
